module Lachstock
  module Helpers
    def versioned_stylesheet(stylesheet)
      ...
      "/#{stylesheet}.css?" + File.mtime(File.join(Sinatra::Application.public, "stylesheets", "#{stylesheet}.css")).to_i.to_s
    end
    def versioned_javascript(js)
      # directory = options.environment == :production ? "javascripts/" : "javascripts"
      "/#{js}.js?" + File.mtime(File.join(Sinatra::Application.public, "javascripts", "#{js}.js")).to_i.to_s
    end
